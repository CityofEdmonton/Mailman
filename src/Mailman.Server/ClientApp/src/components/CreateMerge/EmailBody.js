        ...
        return (
            ...
            >
                <Card style={styles.card}>
                    <Typography variant="h5" style={styles.title}>What would you like your email body to be?</Typography>
                    ...
                    <MuiReactAutosuggest
                        ...
                        closeWrapper=">>"
                    />
                    <Hint title="Recipients will see this as the body of the email.
