...
export default class TitlePage extends Component {
  ...
  constructor(props) {
    super(props)
    this.state = {
      // initialize empty merge title inputs
      mergeTitle: this.props.currentMergeTemplate.title,
      formInput: this.props.currentMergeTemplate.timestampColumn
        .shouldPrefixNameWithMergeTemplateTitle,
    }
  }
  ...
  handleRouting = () => {
    ...
    const oldTimestamp = this.props.currentMergeTemplate.timestampColumn
      .shouldPrefixNameWithMergeTemplateTitle
    if (
      oldTitle !== this.state.mergeTitle ||
      oldTimestamp !== this.state.formInput
    ) {
